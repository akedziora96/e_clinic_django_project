...
urlpatterns = [
    ...
    path('change_password/', views.CustomPasswordChangeView.as_view(), name='change-password'),
    ...
    path('add_multiple_term/', views.MultipleTermAdd.as_view(), name="add-multiple-term"),
