...
def set_up(db):
    for _ in range(10):
        ...
        Procedure.objects.create(name=fake.name(), price=random.uniform(0, 1000.00))
    ...
    for _ in range(1):
        ...
        procedures = list(Procedure.objects.all().order_by('?'))[:3]
        ...
        doctor.procedures.set(procedures)
